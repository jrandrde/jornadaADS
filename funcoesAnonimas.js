...
let resultado = somarParametros(5, 20);
console.log("Resultado da chamada da função somarParametros: " + resultado); //só funciona pq tem o 'return' dentro da função

// Definindo uma função que aceite outra função como argumento
...
console.log(
  "Resultado da execução da função passada como argumento: " + resultadoExecucao
);
